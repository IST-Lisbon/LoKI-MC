...
if "%1" == "all" (
	...
	call .\vcpkg install gsl gsl:x86-windows
	cd ..
	echo ************************************************************************
...
cd ..\Code\build
del /F /Q /S *
cmake -DBOOST_ROOT=C:/DEV/boost_1_77_0 -DGSL_ROOT=C:/DEV/vcpkg/packages/gsl_x86-windows -DCMAKE_GENERATOR_PLATFORM=Win32 -A Win32 ..
